    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 float-left mt-4 ">
                <h1 class="text-danger text-center"><b> About <i class="text-white"> Mapato.</i>
                        <hr class="bg-light">
                    </b></h1>
                <div class="text-light bg-navy p-4" style="border-radius:5%;">
                    <h4 class=" text-light ">Welcome to <b><i class="text-danger"> Mapato </i></b>.This is a place where
                        you can easily :</h4>
                    <ul type="none">
                        <li>
                            <h6 class="text-white "><i class="fa fa-arrow-right bg-danger p-1 text-danger"
                                    style="border-radius:100%;"></i> Monitor Your Budget</h6>
                        </li>
                        <li>
                            <h6 class="text-white "><i class="fa fa-arrow-right bg-danger p-1 text-danger"
                                    style="border-radius:100%;"></i> Monitor Daily Expenses</h6>
                        </li>
                        <li>
                            <h6 class="text-white "><i class="fa fa-arrow-right bg-danger p-1 text-danger"
                                    style="border-radius:100%;"></i> Monitor Daily Earnings</h6>
                        </li>
                        <li>
                            <h6 class="text-white "><i class="fa fa-arrow-right bg-danger p-1 text-danger"
                                    style="border-radius:100%;"></i> Monitor Daily Savings</h6>
                        </li>
                        <li>
                            <h6 class="text-white "><i class="fa fa-arrow-right bg-danger p-1 text-danger"
                                    style="border-radius:100%;"></i> Monitor Your Debts</h6>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="" class="form" id="remember"
