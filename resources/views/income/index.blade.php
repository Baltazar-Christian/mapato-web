...
<div class="container mt-3">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#incomeModal">
                Create Income
            </button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        <a class="btn btn-sm bg-navy p-1" href="EditEarning.php?id"><i
                                                class="fa fa-pen "></i></a>
                                        <a class="btn btn-sm bg-danger p-1"
                                            href="config/DeleteEarning.php?id=
                          "><i
